...
from core.memory_interface import Chapter
...
# chap1 = Chapter(day=date(2025,9,3), memory="Learn hybrid retriever", tags=["ML"])
# storage.save(chap1)
# results = storage.semantic_retrieve("retriever", top_k=5)
# for r in results:
#     print(r["chapter"], r["score"])
